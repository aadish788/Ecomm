...
export const Contact = () => {
                ...
                <div>
                    <section class="bg-white dark:bg-gray-900">
                        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                            ...
                            <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback ? Need details about our Products and Services? Let us know.</p>
    ...
    return localStorage.getItem('userdata') ? mycontact() : null;
